...
def generate_next_img_LK(frame1, frame2):
    flow =  get_LK_flow(frame1, frame2)
    return warp_flow(frame2, flow)
...
frame1 = get_image_by_date_time(19, 8,21,12,1,15)
frame2 = get_image_by_date_time(19, 8,21,12,1,30)
frame3 = get_image_by_date_time(19, 8,21,12,1,45)
